    ...
    <div class="bg-green py-4 <?php if(has_post_thumbnail()): ?> pb-2 <?php else: ?> pb-4 <?php endif; ?> h-auto lg:h-72">
        <div class="container">
            <div class="flex-row hidden lg:flex lg:px-4">
                <a href="<?php echo e(home_url('/')); ?>/about-us/meet-the-team" class="button inline-block bg-white white-bg-orange py-2 px-8 mb-4">< Back to Team</a>

            </div>
            <div class="flex flex-col items-center lg:items-start md:flex-row justify-center lg:px-4">
                <div class="w-full md:w-1/2 lg:w-5/12 px-4 lg:px-0 mb-4">
                ...
                <div class="w-full md:w-1/2 lg:w-7/12 px-4 lg:px-12 mb-16">
                    <div class="montserrat-light text-white leading-normal">
