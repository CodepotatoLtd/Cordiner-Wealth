                    ...
                    <?php if(get_sub_field('image_video')): ?>
                        <div class="w-2/3">
                            <?php if(get_sub_field('youtube_vimeo')): ?>
                                ...
                                <div class="relative bg-black" style="height:470px; overflow:hidden">
                ...
                <?php if($query->have_posts()): ?>
                    ...
                    <div class="flex flex-col md:flex-row -mt-56 mb-24">
                        ...
                        <div
                            ...
                            <h2 class="text-red font-trajan mb-4" data-aos="fade"><?php the_title() ?> </h2>
                            <div class="mb-4 roboto-light text-lg" data-aos="fade-left"
                                 data-aos-delay="300"><?php echo substr(get_the_content(), 0, 100).'...' ?></div>
                        </div>
                    </div>
