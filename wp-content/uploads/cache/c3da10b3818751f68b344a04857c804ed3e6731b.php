                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full md:w-5/12 mb-4 text-center">
                        ...
                        <?php if(get_sub_field('button_text')): ?>
                            <a class="button white-bg-orange py-2 px-16 text-white text-center uppercase lg:mr-24" href="<?php the_sub_field('button_link') ?>"><?php the_sub_field('button_text') ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="w-full md:w-7/12">
                        <div class="montserrat-regular text-md leading-snug md:text-base mb-4 <?php colour('intro') ?>" data-aos="fade-left"
