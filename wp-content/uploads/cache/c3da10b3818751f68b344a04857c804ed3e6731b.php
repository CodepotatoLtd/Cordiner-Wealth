...
<?php if( have_rows('horizontal_panels') ): ?>
    ...
    <?php if(get_row_layout() === 'full_image'): ?>
        ...
        <div class="pt-24" style="background:url('<?php the_sub_field('image') ?>') no-repeat center center; background-size:cover; height:691px">
            <div class="container">
                <div class="w-full md:w-1/2 mx-auto md:mx-0 text-center md:text-left">
                    <h2 class="merriweather-light text-white text-4xl leading-tight mb-4"><?php the_sub_field('title') ?></h2>
                    <p class="text-white mb-6"><?php the_sub_field('text') ?></p>
                    <a class="button white-bg-orange py-2 px-8" href="<?php the_sub_field('button_link') ?>" <?php if(get_sub_field('external_link') == TRUE): ?> target="_blank" <?php endif; ?>><?php the_sub_field('button_text') ?></a>
                </div>
            </div>
        </div>
        <div class="text-center -mt-8">
            <a href="#" class="w-12 h-12 lg:w-16 lg:h-16 mx-auto flex items-center justify-center bg-orange rounded-full"
               data-aos="zoom-in"><img
                    src="<?php echo e(\App\asset_path('images/caret-down.svg')); ?>" alt=""></a>
        </div>
        ...
        <div class="bg-lightgrey py-16 -mt-8">
            <div class="container">
                <div class="flex flex-col text-center mx-auto">
                    <h2 class="merriweather-light text-orange text-4xl leading-none mb-6"><?php the_sub_field('title') ?></h2>
    ...
    <?php elseif(get_row_layout() === 'text_content_nbp'): ?>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full md:w-5/12 mb-4 md:text-center">
                        ...
                        <?php if(get_sub_field('button_text')): ?>
                            <a class="button white-bg-orange py-2 px-16 text-white text-center uppercase md:mr-12 xl:mr-24" href="<?php the_sub_field('button_link') ?>"><?php the_sub_field('button_text') ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="w-full md:w-7/12">
                        <div class="montserrat-regular text-md leading-snug md:text-base mb-4 <?php colour('intro') ?>" data-aos="fade-left"
                    ...
                    <div class="w-full lg:w-3/5">
                        <div class="" style="padding:52.25% 0 0 0;position:relative;">
                            <iframe class="mt-n90 mb-4 lg:mt-0 lg:ml-n100"
                                src="https://player.vimeo.com/video/<?php video_url() ?>?title=0&byline=0&portrait=0"
    ...
    <?php elseif(get_row_layout() === 'cta_centered_app'): ?>
                ...
                <div class="app-buttons mb-6">
                    <div class="flex flex-col text-center mx-auto w-2/3">
                        <?php if(have_rows('app_buttons')): ?>
                            <?php while(have_rows('app_buttons')): ?> <?php the_row() ?>
                                <div class="button-item mx-auto mb-4">
                                    <a href="<?php the_sub_field('link') ?>"><img class="w-200" src="<?php the_sub_field('image') ?>" alt=""></a>
                                </div>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </div>
    ...
    <?php elseif(get_row_layout() === 'content_list_rtbp'): ?>
                    ...
                    <div class="flex flex-col md:flex-row flex-wrap ml-1">
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/4 text-image px-2 mb-4">
                            ...
                            <?php if(has_post_thumbnail()): ?>
                                <div class="relative" style="background:url('<?php echo the_post_thumbnail_url() ?>') no-repeat center center; width:100%; height:300px; overflow:hidden; background-size:cover"></div>
                            <?php endif; ?>
                            </a>
                            <div class="bg-white leading-normal p-4 pt-0 pb-10 border border-lightgrey news-item-text">
                                <h2 class="merriweather-regular text-orange text-lg leading-tight mb-4"><a href="<?php echo e(get_permalink()); ?>"><?php echo e(the_title()); ?></a></h2>
        ...
        <div class="bg-white pt-16">
            <div class="container">
                ...
                <div class="flex flex-col text-center mx-auto mb-8">
                    <h2 class="merriweather-light text-orange text-4xl leading-tight mb-6"><?php the_sub_field('title') ?></h2>
                    <div class="montserrat-regular text-darkgrey w-full md:w-2/3 mx-auto">
                        <?php the_sub_field('text') ?>
                    </div>
                </div>
                ...
                <div class="w-full md:w-1/3 mx-auto bg-white filter-dropdown" style="display:none">
                    <ul>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php endif; ?>
                            <li
                                class="filter-item text-grey p-4 <?php if($count !== $i): ?> border border-2 border-t-0 border-r-0 border-l-0 <?php endif; ?>"
