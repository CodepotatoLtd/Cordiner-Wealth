    ...
    <div class="flex flex-col md:flex-row pt-6">
      ...
      <div class="w-full md:w-3/12 lg:w-3/12">
          <div class="flex flex-col md:flex-row mx-auto justify-center text-center md:text-left">
              <a href="{{ home_url('/') }}" class="footer-logo block mx-auto md:mx-0 lg:mr-12" data-aos="fade">
                  <img class="inline" src="@asset('images/icon-cordiner.svg')" alt="Cordiner Wealth Logo">
              </a>
      ...
      <div class="w-full md:w-4/12 lg:w-3/12 xl:w-3/12">
          ...
          <div class="flex flex-row lg:flex-row w-1/2 md:w-full justify-between mx-auto mt-6">
              @if (have_rows('links','option'))
                  @php $i = 1 @endphp
                  @while (have_rows('links','option')) @php the_row();  @endphp
                    <a class="link" href="@php the_sub_field('link_url') @endphp">@php the_sub_field('link_text') @endphp</a>
                  @php $i++ @endphp
                  @endwhile
              @endif
          </div>
